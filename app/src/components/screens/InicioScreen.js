        ...
        <div className='md:w-2/3 w-full px-4 text-white flex flex-col'>
          ...
          <div className='flex flex-col'>
            <div className='flex mt-24 mb-12 flex-row justify-between'>
              <div>
                <img width='84' height='25' viewBox='0 0 84 25' src='https://res.cloudinary.com/dsulcam/image/upload/v1624776603/skueresoft_qoczsy.png' />
              </div>
              <a className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase'>Sobre Nosotros</a>
              <a className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase'>Servicios</a>
              <a className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase'>Contacto</a>
            ...
            <p className='w-full text-center my-12 text-gray-600'>Copyright © 2021 Skuere-Soft</p>
          </div>
        </div>
      </div>
    </>
